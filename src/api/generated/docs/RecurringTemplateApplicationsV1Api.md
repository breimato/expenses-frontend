...
|------------- | ------------- | -------------|
| [**postRecurringTemplateQuickAddV1**](RecurringTemplateApplicationsV1Api.md#postrecurringtemplatequickaddv1operation) | **POST** /v1/expenses/recurring-templates/{id}/applications | Post Recurring Template Application V1 |
...
async function example() {
  ...
  const api = new RecurringTemplateApplicationsV1Api();
