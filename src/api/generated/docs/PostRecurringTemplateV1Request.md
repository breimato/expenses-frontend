...
```typescript
import type { PostRecurringTemplateV1Request } from ''
...
const example = {
  ...
  "autoApply": null,
  "enabled": null,
} satisfies PostRecurringTemplateV1Request
...
const exampleParsed = JSON.parse(exampleJSON) as PostRecurringTemplateV1Request
